...
class TestProviderDetection:
    ...
    def test_detects_openai_as_plain_chat_completions(self):
        """api.openai.com speaks /chat/completions, not Codex SSE. This
        asserted "openai-codex" until 2026-08-29, which pinned the bug."""
        assert _detect_provider("https://api.openai.com/v1") == "openai"

    def test_detects_a_local_endpoint_as_plain_chat_completions(self):
        assert _detect_provider("http://localhost:8100/v1") == "openai"

    def test_detects_codex_where_it_actually_lives(self):
        assert _detect_provider("https://chatgpt.com/backend-api") == "openai-codex"
